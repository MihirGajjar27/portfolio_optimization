...
export default function RiskProfileQuiz({ loggedIn }) {
  ...
  const step1Questions = [
    {
      ...
      answerChoices: { option1: "< $50K", option2: "$50K - $100K", option3: "$100K - $250K", option4: "250K+"},
      weights: { "< 50K": 0, "$50K - $100K": 1/3, "$100K - $250K": 2/3, "250K+": 1.0},
    },
    {
      id: "q2",
      ...
      weights: { "< 10%": 0, "10% - 20%": 1/3, "20% - 40%": 2/3, "40% +": 1.0 },
    },
    {
      id: "q3",
      question: "What is the total value of your liquid assets (cash, stocks, bonds, etc)?",
      answerChoices: { option1: "< $50K", option2: "$50K - $250K", option3: "$250K - $1M", option4: "1M +"},
      weights: { "< 50K": 0, "$50K - $250K": 1/3, "$250K - $1M": 2/3, "1M +": 1.0},
    },
    {
      id: "q4",
      question: "How many years until you plan to start withdrawing from your investments?",
      answerChoices: { option1: "0 - 5 years", option2: "6 - 10 years", option3: "11 - 20 years", option4: "20 + years" },
      weights: { "0 - 5 years": 0, "6 - 10 years": 1/3, "11 - 20 years": 2/3, "20 + years": 1 },
    },
    {
      id: "q5",
  ...
  const step2Questions = [
    {
      id: "q1",
      question: "If your portfolio dropped 20% in value in one year, how would you react?",
      answerChoices: { option1: "Sell Everything", option2: "Sell some and wait", option3: "Hold", option4: "Buy More" },
      weights: { "Sell Everything": 0, "Sell some and wait": 1/3, "Hold": 2/3, "Buy More": 1 },
    },
    {
      id: "q2",
      question: "What level of annual returns are you comfortable targeting",
      answerChoices: { option1: "3% - 5%", option2: "5% - 8%", option3: "8% - 12%", option4: "12% +" },
      weights: { "3% - 5%": 0, "5% - 8%": 1/3, "8% - 12%": 2/3, "12% +": 1 },
    },
    {
      id: "q3",
  ...
  const step3Questions = [
    {
      id: "q1",
      question: "How do you usually react to financial news that suggests a market downturn?",
      answerChoices: { option1: "Panic & Sell", option2: "Reassess & Adjust", option3: "Stay Invested", option4: "See it as a buying opportunity" },
      weights: { "Panic & Sell": 0, "Reassess & Adjust": 1/3, "Stay Invested": 2/3, "See it as a buying opportunity": 1 },
    },
    {
      id: "q2",
      question: "Do you prefer stability over higher potential returns in your investments?",
      answerChoices: { option1: "Strongly Agree", option2: "Somewhat Agree", option3: "Somewhat Disagree", option4: "Strongly Disagree" },
      weights: { "Strongly Agree": 0, "Somewhat Agree": 1/3, "Somewhat Disagree": 2/3, "Strongly Disagree": 1 },
    },
    {
      id: "q3",
      question: "What is your experience with investing?",
      answerChoices: { option1: "None", option2: "Minimal", option3: "Moderate", option4: "Extensive" },
      weights: { "None": 0, "Minimal": 1/3, "Moderate": 2/3, "Extensive": 1 },
    },
    {
      id: "q4",
      question: "How frequently do you monitor your investment portfolio?",
      answerChoices: { option1: "Daily", option2: "Weekly", option3: "Monthly", option4: "Rarely" },
      weights: { "Daily": 0, "Weekly": 1/3, "Monthly": 2/3, "Rarely": 1 },
    },
    {
      id: "q5",
      question: "If a friend or financial news suggests a different investment strategy than your plan, how likely are you to change your investment approach",
      answerChoices: { option1: "Very Likely", option2: "Somewhat Likely", option3: "Unlikely", option4: "Not at all" },
      weights: { "Very Likely": 0, "Somewhat Likely": 1/3, "Unlikely": 2/3, "Not at all": 1 },
    },
  ];
          ...
          <div className="flex flex-col w-full p-10 bg-gray-100 backdrop-blur-2xl rounded-lg drop-shadow-lg max-w-3xl">
            ...
            {questions.map((q) => (
              <MultipleChoiceQuestion
                key={q.id}
                name={q.id} // pass a unique name for each radio group
                question={q.question}
                answerChoices={q.answerChoices}
                weights={q.weights}
                // Pass any previously stored answer from quizResults, if available.
                initialValue={
                  quizResults[sectionKey] && quizResults[sectionKey][q.id]
                    ? quizResults[sectionKey][q.id][0]
                    : ""
                }
                onAnswerChange={(answer, weight) => handleAnswerChange(q.id, answer, weight)}
              />
            ))}
            {message && (
              <p className={`mt-4 text-center text-lg ${message === "Quiz submitted successfully!" ? "text-green-600" : "text-red-600"}`}>{message}</p>
            )}
